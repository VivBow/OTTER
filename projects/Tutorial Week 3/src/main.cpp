...
int main() {
	...
	Shader* Bishader = new Shader();
	Bishader->LoadShaderPartFromFile("shaders/vertex_shader.glsl", ShaderPartType::Vertex);
	Bishader->LoadShaderPartFromFile("shaders/shader2.glsl", ShaderPartType::Fragment);
	Bishader->Link();
